...
public class HackLayoutInflater {
    ...
    public static Map getConstructorMap() {
        return (Map) ReflectInvoker.getField(null, ClassName, Field_sConstructorMap);
    }

    public static void setConstructorMap(Map map) {
        ReflectInvoker.setField(null, ClassName, Field_sConstructorMap, map);
    }

    public void setPrivateFactory(Object factory) {
        ReflectInvoker.invokeMethod(instance, ClassName, Method_setPrivateFactory, new Class[]{LayoutInflater.Factory2.class}, new Object[]{factory});
    }
